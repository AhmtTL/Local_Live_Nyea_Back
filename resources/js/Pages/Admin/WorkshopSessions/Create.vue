                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">
                                    Add a new session for a workshop in a
                                    specific location
                                </p>
                            </div>
                            <Link
                        ...
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            >
                                <h3
                                    class="text-lg font-semibold text-amber-900 mb-4"
                                >
                                    👑 Program Type
                                </h3>
                                <div
                                ...
                                >
                                    <div>
                                        ...
                                        <InputError
                                            class="mt-2"
                                            :message="form.errors.program_type"
                                        />
                                        <div class="mt-1 text-xs text-gray-600">
                                            ...
                                            <span
                                                v-if="
                                                    ...
                                                    'mastery'
                                                "
                                                >Premium program with extended
                                                content and coaching - Set
                                                direct price below</span
                                            >
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div class="mt-6">
                                    ...
                                    <div class="mt-1 text-xs text-gray-600">
                                        Add special features or benefits
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            :placeholder="
                                                selectedWorkshop
                                                    ? `Leave empty to use base price ($${selectedWorkshop.base_price})`
                                                    : 'Override workshop base price'
                                            "
                                        />
                                        <div class="mt-1 text-xs text-gray-600">
                                            Leave empty to use the workshop's
                                            base price
                                            <span
                                                v-if="selectedWorkshop"
                                                class="font-semibold"
