...
<template>
    <Head title="Edit Resource Session" />
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-8 bg-white border-b border-gray-200">
                        <div class="mb-8">
                            <h2 class="text-3xl font-bold text-gray-900">Edit Resource Session</h2>
                            <p class="text-gray-600 mt-2">Update the details of this resource session</p>
                        </div>
