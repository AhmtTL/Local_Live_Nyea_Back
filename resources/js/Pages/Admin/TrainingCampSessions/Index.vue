...
const deleteSession = (sessionId) => {
    if (
        confirm("Are you sure you want to delete this training camp session?")
    ) {
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">
                                    Manage training camp sessions across
                                    multiple locations
                                </p>
                            </div>
                            <Link
                                :href="
                                    route('admin.training-camp-sessions.create')
                                "
                        ...
                        >
                            ...
                            <h3 class="text-lg font-medium text-gray-900 mb-2">
                                No training camp sessions found
                            </h3>
                            <p class="text-gray-500 mb-6">
                                Get started by creating your first training camp
                                session.
                            </p>
                            <Link
                                :href="
