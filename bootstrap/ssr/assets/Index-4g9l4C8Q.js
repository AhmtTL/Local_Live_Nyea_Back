...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const duplicateSession = (sessionId) => {
      if (confirm(
        "Are you sure you want to duplicate this training camp session? A copy will be created with updated details."
      )) {
    ...
    const togglePublish = (sessionId, currentStatus) => {
      ...
      if (confirm(
        ...
        router.post(
          route("admin.training-camp-sessions.toggle-publish", sessionId)
        );
      }
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Training Camp Sessions Management" }, null, _parent));
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(Layout)), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="p-6 bg-white border-b border-gray-200"${_scopeId}><div class="flex items-center justify-between mb-6"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold text-gray-900"${_scopeId}> Training Camp Sessions </h2><p class="text-gray-600 mt-1"${_scopeId}> Manage training camp sessions across multiple locations </p></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin.training-camp-sessions.create"),
            ...
            ssrRenderList(__props.sessions.data, (session) => {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a2, _b2, _c, _d;
                  if (_push3) {
                    _push3(`<td class="px-6 py-4"${_scopeId2}><div class="text-sm font-medium text-gray-900"${_scopeId2}> 🏕️ ${ssrInterpolate((_a2 = session.program) == null ? void 0 : _a2.title)}</div><div class="text-sm text-gray-500"${_scopeId2}>${ssrInterpolate((_b2 = session.program) == null ? void 0 : _b2.slug)}</div><div class="text-xs text-gray-600 mt-1"${_scopeId2}> 📅 ${ssrInterpolate(formatDateRange(session))}</div></td>`);
                  } else {
                    return [
                      createVNode("td", { class: "px-6 py-4" }, [
                        createVNode("div", { class: "text-sm font-medium text-gray-900" }, " 🏕️ " + toDisplayString((_c = session.program) == null ? void 0 : _c.title), 1),
            ...
            if (!((_a = __props.sessions.data) == null ? void 0 : _a.length)) {
              _push2(`<div class="text-center py-12"${_scopeId}><div class="text-gray-400 text-6xl mb-4"${_scopeId}>🏕️</div><h3 class="text-lg font-medium text-gray-900 mb-2"${_scopeId}> No training camp sessions found </h3><p class="text-gray-500 mb-6"${_scopeId}> Get started by creating your first training camp session. </p>`);
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("admin.training-camp-sessions.create"),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"${_scopeId2}></path></svg> Create Training Camp Session `);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "w-4 h-4",
                      ...
                      createTextVNode(" Create Training Camp Session ")
                    ];
                  }
                }),
                _: 1
                    ...
                    createVNode("div", { class: "p-6 bg-white border-b border-gray-200" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-6" }, [
                        createVNode("div", null, [
                          createVNode("h2", { class: "text-2xl font-bold text-gray-900" }, " Training Camp Sessions "),
                          createVNode("p", { class: "text-gray-600 mt-1" }, " Manage training camp sessions across multiple locations ")
                        ]),
                      ...
                      createVNode("div", { class: "overflow-x-auto" }, [
                        createVNode("table", { class: "min-w-full divide-y divide-gray-200" }, [
                          createVNode("thead", { class: "bg-gray-50" }, [
                            createVNode("tr", null, [
                              createVNode("th", { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }, " Training Camp "),
                              ...
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode(unref(Link), {
                                  ...
                                  default: withCtx(() => {
                                    ...
                                    return [
                                      createVNode("td", { class: "px-6 py-4" }, [
                                        createVNode("div", { class: "text-sm font-medium text-gray-900" }, " 🏕️ " + toDisplayString((_a2 = session.program) == null ? void 0 : _a2.title), 1),
                                        createVNode("div", { class: "text-sm text-gray-500" }, toDisplayString((_b2 = session.program) == null ? void 0 : _b2.slug), 1),
                                        createVNode("div", { class: "text-xs text-gray-600 mt-1" }, " 📅 " + toDisplayString(formatDateRange(session)), 1)
                                      ])
                                    ];
                                  }),
                      ...
                      !((_b = __props.sessions.data) == null ? void 0 : _b.length) ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "text-gray-400 text-6xl mb-4" }, "🏕️"),
                        createVNode("h3", { class: "text-lg font-medium text-gray-900 mb-2" }, " No training camp sessions found "),
                        createVNode("p", { class: "text-gray-500 mb-6" }, " Get started by creating your first training camp session. "),
                        createVNode(unref(Link), {
                          href: _ctx.route("admin.training-camp-sessions.create"),
                          class: "inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200"
                        }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/TrainingCampSessions/Index.vue");
