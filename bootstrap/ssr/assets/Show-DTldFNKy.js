...
import { ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderStyle } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    const togglePublish = () => {
      ...
      if (confirm(`Are you sure you want to ${action} this workshop session?`)) {
        router.post(
          route("admin.workshop-sessions.toggle-publish", props.session.id)
        );
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(Layout)), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="p-6 bg-white border-b border-gray-200"${_scopeId}><div class="flex items-center justify-between mb-6"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold text-gray-900"${_scopeId}> Workshop Session Details </h2><p class="text-gray-600 mt-1"${_scopeId}>${ssrInterpolate((_a = __props.session.program) == null ? void 0 : _a.title)}</p></div><div class="flex items-center space-x-3"${_scopeId}><button class="${ssrRenderClass([
            ...
            if (__props.session.program_type === "mastery") {
              ...
              _push2(`<span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-blue-100 text-blue-800 border border-blue-200"${_scopeId}> ⚡ Essentials Program </span>`);
            }
