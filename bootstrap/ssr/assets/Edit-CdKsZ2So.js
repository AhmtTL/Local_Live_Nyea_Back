...
import { _ as _sfc_main$1 } from "./AuthenticatedLayout-BX2Fm_h0.js";
import _sfc_main$4 from "./DeleteUserForm-BoU4VoAN.js";
import _sfc_main$3 from "./UpdatePasswordForm-CAKf-zj4.js";
import _sfc_main$2 from "./UpdateProfileInformationForm-zUvS-CGF.js";
import { Head } from "@inertiajs/vue3";
import "./BaseLayout-DdSYcoSB.js";
import "./ApplicationLogo-B2173abF.js";
import "./_plugin-vue_export-helper-1tPrXgE0.js";
import "./InputLabel-BdCx2Ft7.js";
import "./Modal-C_wVFe4n.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="mx-auto max-w-screen-2xl space-y-6 sm:px-6 lg:px-8"${_scopeId}><div class="bg-white p-4 shadow sm:rounded-lg sm:p-8"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "py-12" }, [
                createVNode("div", { class: "mx-auto max-w-screen-2xl space-y-6 sm:px-6 lg:px-8" }, [
