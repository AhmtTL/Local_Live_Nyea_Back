import { ref, computed, unref, createVNode, resolveDynamicComponent, withCtx, createTextVNode, createBlock, openBlock, toDisplayString, withModifiers, withDirectives, Fragment, renderList, vModelSelect, createCommentVNode, vModelText, withKeys, vModelCheckbox, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(Layout)), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="p-6 bg-white border-b border-gray-200"${_scopeId}><div class="flex items-center justify-between mb-6"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold text-gray-900"${_scopeId}> Edit Workshop Session </h2><p class="text-gray-600 mt-1"${_scopeId}>${ssrInterpolate(__props.session.location)} - ${ssrInterpolate((_a = __props.session.program) == null ? void 0 : _a.title)}</p></div><div class="flex items-center space-x-3"${_scopeId}><button class="${ssrRenderClass([
            ...
            _push2(`</div></div><form class="space-y-8"${_scopeId}><div class="bg-blue-50 border border-blue-200 rounded-lg p-6"${_scopeId}><h3 class="text-lg font-semibold text-blue-900 mb-4"${_scopeId}> 🎯 Workshop Selection </h3><div${_scopeId}>`);
