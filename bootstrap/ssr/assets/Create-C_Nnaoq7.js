import { ref, computed, unref, createVNode, resolveDynamicComponent, withCtx, createTextVNode, createBlock, openBlock, withModifiers, withDirectives, createCommentVNode, Fragment, renderList, toDisplayString, vModelSelect, vModelText, withKeys, vModelCheckbox, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderVNode, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderClass } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const selectedTrainingCamp = computed(() => {
      return props.trainingCamps.find(
        (tc) => tc.id === parseInt(form.program_id)
      );
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Create Training Camp Session" }, null, _parent));
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(Layout)), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"${_scopeId}><div class="p-6 bg-white border-b border-gray-200"${_scopeId}><div class="flex items-center justify-between mb-6"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold text-gray-900"${_scopeId}> Create Training Camp Session </h2><p class="text-gray-600 mt-1"${_scopeId}> Add a new session for a training camp in a specific location </p></div>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("admin.training-camp-sessions.index"),
            ...
            _push2(`</div><form class="space-y-8"${_scopeId}><div class="bg-orange-50 border border-orange-200 rounded-lg p-6"${_scopeId}><h3 class="text-lg font-semibold text-orange-900 mb-4"${_scopeId}> 🏕️ Training Camp Selection </h3><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              for: "program_id",
              value: "Select Training Camp Program"
            ...
            ssrRenderList(__props.trainingCamps, (trainingCamp) => {
              _push2(`<option${ssrRenderAttr("value", trainingCamp.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).program_id) ? ssrLooseContain(unref(form).program_id, trainingCamp.id) : ssrLooseEqual(unref(form).program_id, trainingCamp.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(trainingCamp.title)} (Base: $${ssrInterpolate(trainingCamp.base_price)}) </option>`);
            });
            _push2(`<!--]--></select>`);
            ...
            if (selectedTrainingCamp.value) {
              _push2(`<div class="mt-3 p-3 bg-white border border-orange-200 rounded"${_scopeId}><div class="text-sm text-orange-800"${_scopeId}><strong${_scopeId}>Selected:</strong> ${ssrInterpolate(selectedTrainingCamp.value.title)}</div><div class="text-xs text-orange-600 mt-1"${_scopeId}> Base Price: $${ssrInterpolate(selectedTrainingCamp.value.base_price)} • You can override this price for this specific session </div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              type: "text",
              class: "mt-1 block w-full",
              placeholder: "e.g., NYEA Mountain Training Center",
              required: ""
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: "mt-2",
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              type: "text",
              class: "mt-1 block w-full",
              placeholder: "e.g., Mountain Leadership Center"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: "mt-2",
            ...
            _push2(`<textarea id="venue_address" class="mt-1 block w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" rows="2" placeholder="e.g., 123 Mountain View Drive, Colorado Springs, CO 80919"${_scopeId}>${ssrInterpolate(unref(form).venue_address)}</textarea>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: "mt-2",
            ...
            if (unref(form).location_highlights.length > 0) {
              ...
              ssrRenderList(unref(form).location_highlights, (highlight, index) => {
                _push2(`<span class="inline-flex items-center bg-green-100 text-green-800 text-sm px-3 py-1 rounded-full border border-green-200"${_scopeId}> ⛰️ ${ssrInterpolate(highlight)} <button type="button" class="ml-2 text-green-600 hover:text-green-800"${_scopeId}> × </button></span>`);
              });
              _push2(`<!--]--></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="mt-1 text-xs text-gray-600"${_scopeId}> Add special features or activities for this training camp location </div></div></div><div class="bg-orange-50 border border-orange-200 rounded-lg p-6"${_scopeId}><h3 class="text-lg font-semibold text-orange-900 mb-4"${_scopeId}> 📅 Schedule &amp; Capacity </h3><div class="grid grid-cols-1 md:grid-cols-2 gap-4"${_scopeId}><div${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              for: "date",
              value: "Primary Date *"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$1, {
              for: "start_date",
              value: "Camp Start Date (Optional)"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, {
              id: "start_date",
            ...
            _push2(`<div class="mt-1 text-xs text-gray-600"${_scopeId}> For multi-day training camps </div>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: "mt-2",
            ...
            _push2(`<textarea id="special_notes" class="mt-1 block w-full border-gray-300 focus:border-purple-500 focus:ring-purple-500 rounded-md shadow-sm" rows="3" placeholder="Any special information about this training camp session..."${_scopeId}>${ssrInterpolate(unref(form).special_notes)}</textarea>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              class: "mt-2",
              message: unref(form).errors.special_notes
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="flex items-center"${_scopeId}><label class="flex items-center"${_scopeId}><input${ssrIncludeBooleanAttr(Array.isArray(unref(form).is_featured) ? ssrLooseContain(unref(form).is_featured, null) : unref(form).is_featured) ? " checked" : ""} type="checkbox" class="rounded border-gray-300 text-purple-600 shadow-sm focus:border-purple-300 focus:ring focus:ring-purple-200 focus:ring-opacity-50"${_scopeId}><span class="ml-2 text-sm text-gray-700"${_scopeId}>Featured Session ⭐</span></label></div></div></div><div class="flex items-center justify-between"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route(
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"${_scopeId2}></path></svg> Cancel `);
                } else {
                  return [
            ...
            _push2(`<div class="flex items-center gap-3"${_scopeId}><button${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="${ssrRenderClass([{
              "opacity-50 cursor-not-allowed": unref(form).processing
            }, "inline-flex items-center gap-2 px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200"])}"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"${_scopeId}></path></svg>`);
            if (unref(form).processing) {
              _push2(`<span${_scopeId}>Saving...</span>`);
            } else {
              _push2(`<span${_scopeId}>📝 Save as Draft</span>`);
            }
            _push2(`</button><button${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="${ssrRenderClass([{
              "opacity-50 cursor-not-allowed": unref(form).processing
            }, "inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5"])}"${_scopeId}><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"${_scopeId}></path></svg>`);
            if (unref(form).processing) {
              _push2(`<span${_scopeId}>Publishing...</span>`);
            } else {
              _push2(`<span${_scopeId}>🚀 Create &amp; Publish</span>`);
            }
                    ...
                    createVNode("div", { class: "p-6 bg-white border-b border-gray-200" }, [
                      createVNode("div", { class: "flex items-center justify-between mb-6" }, [
                        createVNode("div", null, [
                          createVNode("h2", { class: "text-2xl font-bold text-gray-900" }, " Create Training Camp Session "),
                          createVNode("p", { class: "text-gray-600 mt-1" }, " Add a new session for a training camp in a specific location ")
                        ]),
                      ...
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "bg-orange-50 border border-orange-200 rounded-lg p-6" }, [
                          ...
                          createVNode("div", null, [
                            ...
                            withDirectives(createVNode("select", {
                              ...
                              (openBlock(true), createBlock(Fragment, null, renderList(__props.trainingCamps, (trainingCamp) => {
                                return openBlock(), createBlock("option", {
                                  key: trainingCamp.id,
                                  value: trainingCamp.id
                                }, toDisplayString(trainingCamp.title) + " (Base: $" + toDisplayString(trainingCamp.base_price) + ") ", 9, ["value"]);
                              }), 128))
                            ...
                            selectedTrainingCamp.value ? (openBlock(), createBlock("div", {
                              key: 0,
                              class: "mt-3 p-3 bg-white border border-orange-200 rounded"
                            }, [
                              createVNode("div", { class: "text-sm text-orange-800" }, [
                                createVNode("strong", null, "Selected:"),
                                createTextVNode(" " + toDisplayString(selectedTrainingCamp.value.title), 1)
                              ]),
                              createVNode("div", { class: "text-xs text-orange-600 mt-1" }, " Base Price: $" + toDisplayString(selectedTrainingCamp.value.base_price) + " • You can override this price for this specific session ", 1)
                        ...
                        createVNode("div", { class: "bg-green-50 border border-green-200 rounded-lg p-6" }, [
                          ...
                          createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                            ...
                            createVNode("div", { class: "md:col-span-2" }, [
                              ...
                              withDirectives(createVNode("textarea", {
                                ...
                                rows: "2",
                                placeholder: "e.g., 123 Mountain View Drive, Colorado Springs, CO 80919"
                          ...
                          createVNode("div", { class: "mt-6" }, [
                              ...
                              unref(form).location_highlights.length > 0 ? (openBlock(), createBlock("div", {
                                ...
                                (openBlock(true), createBlock(Fragment, null, renderList(unref(form).location_highlights, (highlight, index) => {
                                  return openBlock(), createBlock("span", {
                                    ...
                                    createTextVNode(" ⛰️ " + toDisplayString(highlight) + " ", 1),
                                    createVNode("button", {
                                      type: "button",
                            ...
                            createVNode("div", { class: "mt-1 text-xs text-gray-600" }, " Add special features or activities for this training camp location ")
                          ])
                        ]),
                        createVNode("div", { class: "bg-orange-50 border border-orange-200 rounded-lg p-6" }, [
                          ...
                          createVNode("div", { class: "grid grid-cols-1 md:grid-cols-2 gap-4" }, [
                            ...
                            createVNode("div", null, [
                              ...
                              createVNode("div", { class: "mt-1 text-xs text-gray-600" }, " For multi-day training camps "),
                              createVNode(_sfc_main$2, {
                                class: "mt-2",
                                message: unref(form).errors.start_date
                              }, null, 8, ["message"])
                          ...
                          createVNode("div", { class: "space-y-4" }, [
                            createVNode("div", null, [
                              ...
                              withDirectives(createVNode("textarea", {
                                ...
                                rows: "3",
                                placeholder: "Any special information about this training camp session..."
                              }, null, 8, ["onUpdate:modelValue"]), [
                        ...
                        createVNode("div", { class: "flex items-center justify-between" }, [
                          ...
                          createVNode("div", { class: "flex items-center gap-3" }, [
                            createVNode("button", {
                              ...
                              class: [{
                                "opacity-50 cursor-not-allowed": unref(form).processing
                              }, "inline-flex items-center gap-2 px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200"]
                            }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-4 h-4",
                                fill: "none",
                              ...
                              unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Saving...")) : (openBlock(), createBlock("span", { key: 1 }, "📝 Save as Draft"))
                            ], 10, ["disabled"]),
                            createVNode("button", {
                              ...
                              class: [{
                                "opacity-50 cursor-not-allowed": unref(form).processing
                              }, "inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200 transform hover:-translate-y-0.5"]
                            }, [
                              (openBlock(), createBlock("svg", {
                                class: "w-4 h-4",
                                fill: "none",
                              ...
                              unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Publishing...")) : (openBlock(), createBlock("span", { key: 1 }, "🚀 Create & Publish"))
                            ], 10, ["disabled"])
                          ])
                        ])
                      ], 40, ["onSubmit"])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/TrainingCampSessions/Create.vue");
